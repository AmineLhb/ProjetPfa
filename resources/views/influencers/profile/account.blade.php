...
<div class="row">
    <div class="col-md-12  mb-4 mb-md-0">
        <div class="card">
            <h2 class="card-title text-center p-4">To be published products</h2>
          <div class="table-responsive text-nowrap">
            <table class="table datatable-project border-top">
                ...
                <tbody class="table-border-bottom-0">
                  @foreach($aplliedProduct as $product)
                    <tr>
                      <td>
                        {{$product->id}}
                      </td>
                      ...
                      <td>
                        ...
                        @if($product->pivot->status)
                          <a href="https://web.facebook.com/sharer/sharer.php?u={{route('web',['id'=>$product->id])}}" class="btn btn-outline-info">Publish</a>
                        @endif
                      </td>
...
<div class="row">
    <div class="col-md-12  mb-4 mb-md-0">
        <div class="card">
            <h2 class="card-title text-center p-4">Favorite products</h2>
